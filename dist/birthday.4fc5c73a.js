    ...
    return `
            <li class='list-of-data' data-id="${data.id}">
                ...
                <div class="names-and-date">
                    ...
                    <p class="date">Turns <span class="future-age">${futAge}</span> on ${monthNname}<span> ${(0, _format.default)(new Date(data.birthday), "do")}
                    </span>
                    </p>
                </div>   
                <div class="group-btn">
...
;
},{"date-fns/format":"node_modules/date-fns/esm/format/index.js"}],"component/birthday.js":[function(require,module,exports) {
"use strict";
