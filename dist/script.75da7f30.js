...
function _populateData() {
  _populateData = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
    var persons, sortedData, html;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            ...
            sortedData = persons.sort(function (a, b) {
              return b.rt_score - a.rt_score;
            });
            html = sortedData.map(function (data) {
              return "\n            <article>\n                <h3>".concat(data.firstName, "</h3>\n                <p>").concat(data.lastName, "</p>\n                <p>").concat(data.birthday, "</p>\n                <p>").concat(data.picture, "</p>\n                <p>").concat(data.id, "</p> \n            </article>\n        ");
            }).join('');
